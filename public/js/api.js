...
export const api = {
  ...
  inviaBattuta: (id, npc, testo) => richiesta(`/api/partite/${encodeURIComponent(id)}/dialogo`, { metodo: "POST", corpo: { npc, testo } }),
  storiaDialogo: (id, npc) => richiesta(`/api/partite/${encodeURIComponent(id)}/dialogo/${encodeURIComponent(npc)}`),
